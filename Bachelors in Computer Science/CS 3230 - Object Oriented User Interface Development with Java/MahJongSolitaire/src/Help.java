...
public class Help extends JPanel implements HyperlinkListener
{
	...
	public Help(String file, String title)
	{
		...
		frame = new JFrame();
		URL	url = Help.class.getResource("Help24.gif");
		...
		JButton	close = makeButton("Stop24.gif", "Close the help system",
				"close", this);
	...
	public Help(String file)
	{
		...
		back = makeButton("Back24.gif", "Return to the previous help page", "back", this);
		next = makeButton("Forward24.gif", "Goto the next help page", "forward", this);
	...
	//	Method added to assist with making new JButtons
	public JButton makeButton(String file, String tip, String method, Object target)
	{
		JButton button;
		URL url = Help.class.getResource(file);
